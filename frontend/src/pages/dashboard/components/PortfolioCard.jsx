        ...
        <Card title="Paper Portfolio" actions={<a href="/paper" className="text-xs text-primary-400 hover:text-primary-300">View</a>}>
            <div className="space-y-4">
                <div className="p-3 bg-dark-800 rounded-lg">
                    ...
                    <p className="text-lg font-bold text-dark-50 font-mono">{formatCurrency(account.available_balance)}</p>
                </div>
                <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 bg-dark-800 rounded-lg">
                        <p className="text-xs text-dark-500">Today PnL</p>
                        <p className={`text-sm font-bold font-mono ${pnlPositive ? "text-green-400" : "text-red-400"}`}>{pnlPositive ? "+" : ""}{formatCurrency(account.today_pnl)}</p>
                    </div>
                    <div className="p-3 bg-dark-800 rounded-lg">
                    ...
                    <div className="p-3 bg-dark-800 rounded-lg">
                        ...
                        <p className="text-sm font-bold text-dark-100">{account.win_rate}%</p>
                    </div>
                </div>
            </div>
        </Card>

...
export default function RecentSignalsTable({ signals = [] }) {
    ...
    return (
        <Card title="Strategy Signals" subtitle="Active signals from all strategies" actions={<a href="/strategies/signals" className="text-xs text-primary-400 hover:text-primary-300">View All</a>} padding={false}>
            <Table columns={columns} data={signals} emptyTitle="No active signals" emptyDescription="Run strategies to generate signals" />
        </Card>
    );
}
